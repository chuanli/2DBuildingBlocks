...
P.name_dataset = 'TextureOptimization';
  for i_img =7:37
     ...
     fprintf(fileID, ['\\includegraphics[height= 0.1\\textheight, width=.24\\columnwidth, keepaspectratio]{Fig/' P.name_dataset '/' P.name_dataset '(' num2str(i_img) ')_syn_TO.png} &\n']);
     fprintf(fileID, ['\\includegraphics[height= 0.1\\textheight, width=.24\\columnwidth, keepaspectratio]{Fig/' P.name_dataset '/' P.name_dataset '(' num2str(i_img) ')_syn_BDS.png} &\n']);
