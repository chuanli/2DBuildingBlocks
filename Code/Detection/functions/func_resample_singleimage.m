function [D_buffer, D_train] = func_resample_singleimage(D_buffer, D_train, P, f_render)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% we need to filter out the building blocks that do not repeat in any image
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if P.detectorimprove_supervision == 0
...
D_temp.new_hog_key_mean = zeros(P.pre_hog_dim, size(D_buffer.cluster, 2));
D_temp.new_hog_key_mean_NN = zeros(P.pre_hog_dim, size(D_buffer.cluster, 2));
D_temp.new_hog_key_mean_KNN = zeros(P.pre_hog_dim, size(D_buffer.cluster, 2));
